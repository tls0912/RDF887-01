...
/**
 * Working Beam 請求產生策略接口
 * <p>
 * - 每個裝置依據 PLC 狀態與當前任務狀況，自主判斷是否需要產生 Request
 ...
 */
public interface WorkingBeamRequestGenerator {

    /**
     * 嘗試產生一筆新的 Working Beam Request（若符合條件）
     *
     * @param workingBeamId Working Beam 裝置 ID
     * @return 成功產生時，回傳新 Request 的 ID；否則 Optional.empty()
     */
    Optional<Long> generateRequest(Long workingBeamId);
}
